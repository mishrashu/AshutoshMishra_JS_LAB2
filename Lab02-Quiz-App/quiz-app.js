...
class QACombination {
    constructor(questionObj, correctAnswerObj, answerOptions) {
...
class VerifyUserAnswerFromQACombinations {
    constructor(qaCombination) {
    ...
    constructor(qaCombinations) {
        ...
        this.displayQACombinationSection = function () {
            ...
            for (let index = 0; index < 4; index++) {
                ...
                const answerOptionValue = qaCombination.answerOptions[index].answerOptionText;
